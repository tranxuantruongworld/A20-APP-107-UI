  ...
  const reviews = [
    {
      ...
      content:
        "Conference Hub transformed how we engage with our audience. The AI moderation saved us countless hours while ensuring every important question was addressed. Absolutely revolutionary!",
      rating: 5,
    },
    {
      ...
      role: "CEO, StartupX",
      content:
        "The real-time sync is incredible. Our remote team felt just as connected as those in the room. This platform is a game-changer for hybrid events and global conferences.",
      rating: 5,
    },
    {
      name: "Emily Watson",
      ...
      content:
        "We have tried many Q&A platforms, but Conference Hub stands out with its elegant design and powerful features. Our attendees absolutely love the seamless experience!",
      rating: 5,
    },
    {
      name: "David Kim",
      ...
      content:
        "The security features gave us confidence to use this for our internal all-hands meetings. Enterprise-grade protection with consumer-grade ease of use is a rare combination.",
      rating: 5,
    },
    {
      name: "Jennifer Park",
      ...
      content:
        "The analytics dashboard provides invaluable insights into audience engagement. We can now measure the success of our events with concrete data and improve continuously.",
      rating: 5,
    },
    {
      ...
      content:
        "Managing Q&A for 5000+ attendees used to be a nightmare. Conference Hub made it effortless. The AI prioritization ensures the best questions always rise to the top.",
      rating: 5,
    },
    {
      name: "Lisa Thompson",
      ...
      content:
        "The multi-language support opened our conferences to a global audience. Attendees can ask questions in their native language and everyone stays connected.",
      rating: 5,
    },
    {
      name: "James Wilson",
      ...
      content:
        "From small workshops to massive keynotes, Conference Hub scales beautifully. The interface is intuitive and our speakers love the streamlined experience.",
      rating: 5,
    },
  ];
              ...
              <form onSubmit={handleJoinRoom} className="space-y-5">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-2 text-center">
                    ...
                    <span className="font-mono text-primary/80">CONF2026</span>,{" "}
                    <span className="font-mono text-primary/80">MEET-ABC</span>,{" "}
                    <span className="font-mono text-primary/80">QA-LIVE</span>
                  </p>
                </div>
